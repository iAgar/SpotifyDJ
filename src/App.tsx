...
function App() {
  ...
  const { energyScore, isActive, cameraError, videoRef, startCamera, stopCamera } =
    useMotionDetector();
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        {/* Centre: Next Song + Start / Stop Party */}
        ...
        {/* Bottom-right: Camera preview — always mounted so videoRef is populated before startCamera runs */}
        <div style={{ flex: 1, maxWidth: 320, display: 'flex', justifyContent: 'flex-end' }}>
          {cameraError ? (
            <div style={{
              ...
              <div style={{ fontSize: 11, color: '#555' }}>No camera</div>
            </div>
          ) : (
            <div style={{
              position: 'relative',
